...
listWordAfterDigit([],Res,Res):-!.
listWordAfterDigit([H|T],I,Res):-get_words(H,Words),countWordsAfterDigit(Words,0,CountWords),append(I,[CountWords],I1),listWordAfterDigit(T,I1,Res).


countWordsAfterDigit([_],CountWords,CountWords):-!.
countWordsAfterDigit([H|T],I,CountWords):-digitCount(H,0,DigitCount),(DigitCount>0->I1 is I+1,countWordsAfterDigit(T,I1,CountWords);countWordsAfterDigit(T,I,CountWords)).

digitCount([],Count,Count):-!.
digitCount([H|T],I,Count):-H>=48,H=<57->I1 is I+1,digitCount(T,I1,Count);digitCount(T,I,Count).
...
pr7:-see('C:/Users/User/Desktop/Func_and_Log/Laba8/Prolog7.txt'),read_list_str(A), seen,tell('C:/Users/User/Desktop/Func_and_Log/Laba8/Prolog7.txt'),listWordAfterDigit(A,[],ListWord),listSorter(ListWord,_,A,SortedA),write_list_str(SortedA),told.
